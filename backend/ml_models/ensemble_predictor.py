...
class EnsemblePredictor:
    ...
    def get_prediction(self, ticker: str, price_data: np.ndarray, sentiment_data: Dict) -> Optional[Dict]:
        try:
...
# Module-level function for Airflow or external scripts
def get_prediction(ticker: str, price_data: np.ndarray, sentiment_data: Dict) -> Optional[Dict]:
    ...
    predictor = EnsemblePredictor(lstm_model, sentiment_analyzer)
    return predictor.get_prediction(ticker, price_data, sentiment_data)